...
- **Synthesis:** When creating a NEW synthesized lesson (triggered by 5+ raw entries), you MUST call `get_lesson_ancestry` for any source that is already synthesized. Identify and resolve contradictions by prioritizing the most recent findings.
