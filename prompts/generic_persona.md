...
3. **Audit:** During synthesis, use `get_lesson_ancestry` to ensure you are not building on top of stale or contradictory findings. Prioritize recent project evidence.
